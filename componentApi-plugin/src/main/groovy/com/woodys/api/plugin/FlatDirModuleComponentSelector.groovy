...
public class FlatDirModuleComponentSelector implements ModuleComponentSelector {
    ...
    private final List<com.woodys.api.plugin.maven.Capability> requestedCapabilities
    private final int hashCode

    private FlatDirModuleComponentSelector(ModuleIdentifier module, ImmutableVersionConstraint version, ImmutableAttributes attributes, List<com.woodys.api.plugin.maven.Capability> requestedCapabilities) {
    ...
    List<com.woodys.api.plugin.maven.Capability> getRequestedCapabilities() {
    ...
    public static ModuleComponentSelector newSelector(String name) {
        return new FlatDirModuleComponentSelector(DefaultModuleIdentifier.newId("", name), DefaultImmutableVersionConstraint.of(), ImmutableAttributes.EMPTY, new ArrayList<com.woodys.api.plugin.maven.Capability>())
    }
}